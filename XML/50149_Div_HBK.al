xmlport 50150 "50150_Posting_Setup_ERPG"
{
    ...
    begin
        ...
        IF svar = 3 then begin
            ...
            if strlen(Felt03) < 4 then
                Felt03 := '0' + Felt03;
            if (strlen(Felt04) < 4) and (Felt04 <> 'Tøj') and (Felt04 <> 'Vin') then
                Felt04 := '0' + Felt04;
            if strlen(Felt05) < 4 then
                Felt05 := '0' + Felt05;
            ...
            if Felt02 = '3' then begin  //kreditor
                ...
                if GenPostSetup.FindSet then
                    repeat
                        if strlen(felt05) > 1 then begin
                            GenPostSetup."Purch. Account" := '00009995'; //'0000' + Felt05;
                            GenPostSetup."Purch. Credit Memo Account" := '00009995'; //'0000' + Felt05;
                        end;
                        GenPostSetup.Modify;
                    until GenPostSetup.Next = 0;
            end;
