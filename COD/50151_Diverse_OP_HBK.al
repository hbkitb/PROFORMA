codeunit 50151 "50151_Diverse_OP_ERPG"
{
    ...
    begin
        ...
        Svar01 := Dialog.StrMenu('Imp LagKart,Imp DebKart,Imp Medarb,Imp Varegrp,Imp KostVAL,Check Kost,Opd.Sælger,Imp.DebMail');
        ...
        case Svar01 of
            ...
            7:
                begin
                    Message('Opdat Sælger');
                    cust.Reset;
                    if cust.FindSet then
                        repeat
                            cust.SalesRepPRO := cust."Salesperson Code";
